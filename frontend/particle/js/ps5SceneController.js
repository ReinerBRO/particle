...
export class PS5SceneController {
    ...
    async createGalleryParticles() {
        ...
        this.galleryGroup.position.set(0, 0, -4); // Center around the tree
    ...
    updateSkyGallery(time) {
        ...
        // Rotate the entire gallery slowly - around vertical axis (Y) since it's flat now
        this.galleryGroup.rotation.y += 0.0005;
